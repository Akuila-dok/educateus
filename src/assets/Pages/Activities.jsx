...
import femaleResiliencePhoto3 from '../../assets/femaleresilience3.jpg';
 ...
 import ValiantartPhoto1 from '../../assets/Valiantart1.jpg';
 import ValiantartPhoto2 from '../../assets/Valiantart2.jpg';
 import ValiantartPhoto3 from '../../assets/Valiantart3.jpg';
      ...
      <div className="container">
        <div className="board-content">
          ...
          <div className="activity">
            <h2>Valiant Arts</h2>
            <p>
              We are also commited in bringing talents to life by promoting arts and culture through the valiant art. 
            </p>
            {/* Uncomment and use this carousel when English course photos are available */}
            { <Carousel showThumbs={false} autoPlay infiniteLoop>
              <div>
                <img src={ValiantartPhoto1} alt="Valiant Art 1" />
              </div>
              <div>
                <img src={ValiantartPhoto2} alt="Valiant Art 2" />
              </div>
              <div>
                <img src={ValiantartPhoto3} alt="Valiant Art 3" />
              </div>
            </Carousel> }
          </div>
